# AUTOGENERATED! DO NOT EDIT! File to edit: ../notebooks/03_utils.ipynb.

# %% auto 0
__all__ = ['discord_message_to_message', 'split_into_shorter_messages', 'is_last_message_stale', 'close_thread', 'should_block']

# %% ../notebooks/03_utils.ipynb 2
...
# %% ../notebooks/03_utils.ipynb 3
from biobot.base import Message

# %% ../notebooks/03_utils.ipynb 4
import logging
logger = logging.getLogger(__name__)

# %% ../notebooks/03_utils.ipynb 5
